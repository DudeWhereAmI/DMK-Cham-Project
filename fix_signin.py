...
with open('src/components/SignInForm.tsx', 'r') as f:
    content = f.read()

# Make it more blocky/aesthetic
new_form = """import React, { useState } from 'react';
...
with open('src/components/SignInForm.tsx', 'w') as f:
    f.write(new_form)
