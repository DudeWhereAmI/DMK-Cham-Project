...
import { getProductBasePrice, PRODUCTS, MIRROR_IMAGES_CHU_NOI, MIRROR_IMAGES_LINH_VAT } from '../data';
...
const FONTS: FontProfile[] = [
  {
    ...
    descVi: 'Font chữ nổi 3D sang trọng, tạo cảm giác liền mạch, độc đáo trên bề mặt chất liệu.',
    descEn: 'Luxurious 3D embossed font, creating a seamless and unique feeling on the material surface.',
    colorHex: '#D1ECFC',
    gradientFrom: '#CBE5FF',
    gradientTo: '#8FBFE5',
    imgUrl: 'https://raw.githubusercontent.com/DudeWhereAmI/Digital-Marketing-ISB-Cham-Project/63f722cf71afbdc305860327c408c71b406e9090/BRAND%20ELEMENT/M%E1%BA%AAU/font_embossed.png'
  },
  {
    id: 'sticker',
    nameVi: 'Chữ Dán',
    nameEn: 'Sticker Text',
    descVi: 'Font chữ dạng dán tinh tế, gọn gàng, làm nổi bật thông điệp cá nhân mà không phá vỡ cấu trúc kẹp.',
    descEn: 'Neat and delicate sticker font, highlighting your personal message without breaking the clip\\'s structure.',
    colorHex: '#FADBDC',
    gradientFrom: '#FFD3D4',
    gradientTo: '#E59CA0',
    imgUrl: 'https://raw.githubusercontent.com/DudeWhereAmI/Digital-Marketing-ISB-Cham-Project/63f722cf71afbdc305860327c408c71b406e9090/BRAND%20ELEMENT/M%E1%BA%AAU/font_sticker.png'
  }
];
  ...
  const getDisplayImage = (fontId: string, productId: string) => {
    if (productId === 'kep-1') { 
      return fontId === 'sticker' 
        ? 'https://raw.githubusercontent.com/DudeWhereAmI/Digital-Marketing-ISB-Cham-Project/ed49c7fb37b8188fd6af54a285bdb84289237822/new/%C3%A1nh%20m%C3%A2y%20ch%E1%BB%AF%20d%C3%A1n%205%20m%C3%A0u%20.png'
        : 'https://raw.githubusercontent.com/DudeWhereAmI/Digital-Marketing-ISB-Cham-Project/ed49c7fb37b8188fd6af54a285bdb84289237822/new/%C3%A1nh%20m%C3%A2y%20ch%E1%BB%AF%20n%E1%BB%95i%205%20m%C3%A0u.png';
    } else if (productId === 'kep-2') { 
      return fontId === 'sticker'
        ? 'https://raw.githubusercontent.com/DudeWhereAmI/Digital-Marketing-ISB-Cham-Project/ed49c7fb37b8188fd6af54a285bdb84289237822/new/pha%20l%C3%AA%20ch%E1%BB%AF%20d%C3%A1n%205%20m%C3%A0u.png'
        : 'https://raw.githubusercontent.com/DudeWhereAmI/Digital-Marketing-ISB-Cham-Project/ed49c7fb37b8188fd6af54a285bdb84289237822/new/pha%20l%C3%AA%20ch%C6%B0%20n%E1%BB%95i%205%20m%C3%A0u%20.png';
    } else {
      return fontId === 'sticker' 
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex flex-col">
                        <span className="text-[#00687A]/50 text-xs font-bold line-through">
                          {new Intl.NumberFormat('vi-VN').format(getProductBasePrice('kep-1') + (font.id === 'sticker' ? 3000 : 5000))}đ
                        </span>
                        <span className="text-[#00687A] text-xl font-black tracking-tight leading-none">
                          {new Intl.NumberFormat('vi-VN').format(Math.round((getProductBasePrice('kep-1') + (font.id === 'sticker' ? 3000 : 5000)) * 0.9))}<span className="text-xs underline ml-0.5">đ</span>
                ...
                <div className="flex flex-col gap-4 mt-6">
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      ...(font.id !== 'sticker' ? [{ id: 'guong', label: lang === 'vi' ? 'Gương' : 'Mirror' }] : []),
                    ].map(opt => (
                      <button
                        key={opt.id}
                        onClick={(e) => { e.stopPropagation(); handleProductSelect(font.id, opt.id); }}
                  ...
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      onNavigateCustomizer(font.id, getSelectedProduct(font.id));
                    }}
              ...
              <div className="flex-[2] h-full flex flex-col items-center justify-center relative min-h-[300px] md:min-h-[400px]">
                ...
                <div className="flex-1 w-full flex items-center justify-center relative">
                  {(() => {
                    ...
                    const isPhaLeDan = font.id === 'sticker' && selectedProductId === 'kep-2';
                    ...
                    return (
                      <img 
                        src={getDisplayImage(font.id, getSelectedProduct(font.id))}
                        alt={font.nameEn} 
...
fs.writeFileSync('src/components/CollectionChamToi.tsx', code);
